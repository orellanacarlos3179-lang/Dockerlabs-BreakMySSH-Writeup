...
Vector de Ataque: Fuerza bruta contra el servicio OpenSSH (Port 22) seguido de un acceso directo con la cuenta de superusuario.
...
Resultado: Se identificaron credenciales válidas para el usuario root.
...
Forzar el uso exclusivo de llaves SSH (public/private keys):
